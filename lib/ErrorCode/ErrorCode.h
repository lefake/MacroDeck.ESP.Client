...
#define NO_STRIP_MODULE_UPDATE      GEN_ERROR_CODE(SUCCESS, 5)

// ==========  WARNING CODES ========== 

// ========== ERROR CODES ========== 
#define HTTP_GET_ERROR              GEN_ERROR_CODE(ERROR, 1)
#define HTTP_POST_ERROR             GEN_ERROR_CODE(ERROR, 2)
#define HTTP_TIMEOUT_ERROR          GEN_ERROR_CODE(ERROR, 3)
